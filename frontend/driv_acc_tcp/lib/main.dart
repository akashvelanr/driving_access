...
import 'package:driv_acc_tcp/new_user_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _showSettingsDialog() {
    TextEditingController fpTcpIpController =
        TextEditingController(text: fpTcpIp);
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  fpTcpIp = fpTcpIpController.text;
